...
<div class="container-fluid" >
    <div class="row bg-title" >
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="fa fa-suitcase fa-fw" aria-hidden="true"></i> Data Outlet</h4> </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                <div class="row">
                    <div class="col-md-6">
                        <a href="outlet_tambah.php" class="btn btn-success box-title" style="background-color: red"><i class="fa fa-plus fa-fw"></i> Tambah Data</a>
                    </div>
                    ...
                    <table class="table table-striped" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-left" style="background-color: red">Owner</th>
                                <th class="text-left" style="background-color: red">No Telepon</th>
                                <th class="text-left" style="background-color: red">Alamat</th>
                                <th class="text-left" style="background-color: red">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
