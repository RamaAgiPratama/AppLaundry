    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="white-box" style="margin-top:0px">
                ...
                <a href="print.php" class="btn btn-success box-title"  style="background-color: red" > <i class="fa fa-plus fa-fw"></i> Cetak</a>
                    ...
                    <table class="table table-striped" id="table">
                        <thead>
                            <tr>
                                ...
                                <th  class="text-left"  style="background-color: red">Jumlah Transaksi</th>
                                <th  class="text-left"  style="background-color: red">Tanggal Transaksi</th>
                                <th  class="text-left"  style="background-color: red">Total Hasil</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
