    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                <div class="row">
                    <div class="col-md-6">
                        <a href="transaksi_cari_member.php" class="btn btn-success box-title"  style="background-color: red"><i class="fa fa-plus fa-fw"></i> Tambah Data</a>
                        ...
                        <tbody>
                            ...
                            <?php foreach($data as $transaksi): ?>
                                <tr>
                                    ...
                                    <td align="center">
                                          <a href="transaksi_detail.php?id=<?= $transaksi['id_transaksi']; ?>" style="background-color: red" data-toggle="tooltip" data-placement="bottom" title="Detail" class="btn btn-success btn-block"><i class="fa fa-eye fa-fw"></i> Detail</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
