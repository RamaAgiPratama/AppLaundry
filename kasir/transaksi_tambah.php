...
if(isset($_POST['btn-simpan'])){   
    ...
    $diskon = $_POST['diskon'];
    $ongkir_kurir = $_POST['ongkir_kurir'];
    
    $query = "INSERT INTO transaksi (outlet_id,kode_invoice,member_id,tgl,batas_waktu,biaya_tambahan,diskon,ongkir_kurir,status,status_bayar,user_id) VALUES ('$outlet_id','$kode_invoice','$member_id','$tgl_sekarang','$batas_waktu','$biaya_tambahan','$diskon','$ongkir_kurir','baru','belum','$user_id')";
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                ...
                <div class="form-group">
                    <label>Ongkir kurir</label>
                    <input autocomplete="off" type="text" name="ongkir_kurir" class="form-control" value="0"> 
                </div>
